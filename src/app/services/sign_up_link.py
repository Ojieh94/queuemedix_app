...
async def create_admin_signup_link(email: str, notes: str, admin_type: AdminType, hospital_uid: uuid.UUID, session: AsyncSession, department_uid: uuid.UUID) -> str:
...
async def create_practitioner_signup_link(email: str, notes: str, type: PractitionerType, hospital_uid: uuid.UUID, department_uid: uuid.UUID, session: AsyncSession) -> str:
    token = secrets.token_urlsafe(32)
